    ...
    <div class="row g-5">
        ...
        <div class="col-lg-8">
            ...
            <div class="position-relative mb-3">
                <span class="badge-type"><?php echo $row['status']; ?></span>
                <img class="gallery-main" src="<?php echo $row['image']; ?>">
            </div>
            ...
            <div class="card-section">
                ...
                <p class="property-price text-primary"><?php echo $row['price']; ?></p>
                <p>
            ...
            <div class="card-section">
                ...
                This is a <?php echo $row['type']; ?> located in <?php echo $row['location']; ?>.
                </p>
            </div>
            ...
            <div class="card-section">
                ...
                <li><i class="fa fa-check text-primary me-2"></i><?php echo $row['area']; ?></li>
                <li><i class="fa fa-check text-primary me-2"></i><?php echo $row['feature1']; ?></li>
                <li><i class="fa fa-check text-primary me-2"></i><?php echo $row['feature2']; ?></li>
            </ul>
            </div>
        ...
        <div class="col-lg-4">
            <div class="action-box">
                <h4 class="mb-2">₹ <span><?php echo $row['price']; ?></span></h4>
